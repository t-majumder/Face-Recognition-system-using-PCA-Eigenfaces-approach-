...
image_paths = list(paths.list_images(r"C:\Users\987ta\Desktop\2023PHS7226_TamalMajumder_A2\Data Multi class\training"))
...
s=25/17; top_k_ind=sorted_ind[:k]
...
test_images = process_test_images(r"C:\Users\987ta\Desktop\2023PHS7226_TamalMajumder_A2\Data Multi class\test")

test_labels = np.arange(0,100,1)  
...
def compute_accuracy(test_images, test_labels, weights, projection, mean_face, eigenfaces):
    ...
    # Calculate accuracy
    accuracy = (numb_correct / num_image) * 100.0
    return accuracy
# Accuracy
